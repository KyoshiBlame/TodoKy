...
type ValidateRequestToken struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *ValidateRequestToken) Reset() {
	*x = ValidateRequestToken{}
	mi := &file_proto_auth_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ValidateRequestToken) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ValidateRequestToken) ProtoMessage() {}

func (x *ValidateRequestToken) ProtoReflect() protoreflect.Message {
	mi := &file_proto_auth_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ValidateRequestToken.ProtoReflect.Descriptor instead.
func (*ValidateRequestToken) Descriptor() ([]byte, []int) {
	return file_proto_auth_proto_rawDescGZIP(), []int{4}
}

func (x *ValidateRequestToken) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
type ValidateResponseToken struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *ValidateResponseToken) Reset() {
	*x = ValidateResponseToken{}
	mi := &file_proto_auth_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ValidateResponseToken) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ValidateResponseToken) ProtoMessage() {}

func (x *ValidateResponseToken) ProtoReflect() protoreflect.Message {
	mi := &file_proto_auth_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ValidateResponseToken.ProtoReflect.Descriptor instead.
func (*ValidateResponseToken) Descriptor() ([]byte, []int) {
	return file_proto_auth_proto_rawDescGZIP(), []int{5}
}

func (x *ValidateResponseToken) GetValid() bool {
	if x != nil {
		return x.Valid
	}
	return false
...
func (x *ValidateResponseToken) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *ValidateResponseToken) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
const file_proto_auth_proto_rawDesc = "" +
	...
	"\x14ValidateRequestToken\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\"\\\n" +
	"\x15ValidateResponseToken\x12\x14\n" +
	...
	"\bValidate\x12\x1a.auth.ValidateRequestToken\x1a\x1b.auth.ValidateResponseTokenB%Z#github.com/KyoshiBlame/TodoKy/protob\x06proto3"
...
var file_proto_auth_proto_goTypes = []any{
	...
	(*ValidateRequestToken)(nil),  // 4: auth.ValidateRequestToken
	(*ValidateResponseToken)(nil), // 5: auth.ValidateResponseToken
}
var file_proto_auth_proto_depIdxs = []int32{
	...
	4, // 2: auth.AuthService.Validate:input_type -> auth.ValidateRequestToken
	1, // 3: auth.AuthService.Register:output_type -> auth.RegisterResponse
	3, // 4: auth.AuthService.Login:output_type -> auth.LoginResponse
	5, // 5: auth.AuthService.Validate:output_type -> auth.ValidateResponseToken
